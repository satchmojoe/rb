...
# section information
fe = FormElement.create form_id: form.id, element_type_id: ElementType.find_by_e_type("section").id, element_id: 3, element_name: "element_3_1", element_title: "SECTION A: Your Work Area/Unit", element_tool_tip: "In this survey, think of your ÒunitÓ as the work area, department, or clinical area of the hospital where you spend most of your work time or provide most of your clinical services."
...
for opt in ["MICU/SICU: Combined medical/surgical ICU","CCU: Coronary Care Unit","CVICU: Cardio-vascular ICU","MICU: Medical ICU","NICU: Neonatal ICU","N-ICU: Neuro ICU","PICU: Pediatric ICU","SICU: Surgical ICU","Other"] do
ElementOption.create form_element_id: fe.id, option: opt, position: fe.element_options.count
end
...
"It is just by chance that more serious mistakes donÕt happen around here.",
...
# section information
fe = FormElement.create form_id: form.id, element_type_id: ElementType.find_by_e_type("section").id, element_id: 9, element_name: "element_9_1", element_title: "SECTION B: Your Supervisor/Manager/Department Chair", element_tool_tip: "Please indicate your agreement or disagreement with the following statements about your immediate supervisor/manager or person to whom you directly report."
...
# section information
fe = FormElement.create form_id: form.id, element_type_id: ElementType.find_by_e_type("section").id, element_id: 13, element_name: "element_13_1", element_title: "SECTION D: Frequency of Events Reported", element_tool_tip: "In your hospital work area/unit, when the following mistakes happen, <i>how often are they reported?</i>"
...
for opt in ["E: Failing","D: Poor","C: Acceptable","B: Very Good","A: Excellent"] do
ElementOption.create form_element_id: fe.id, option: opt, position: fe.element_options.count
end
end
...
"Things Òfall between the cracksÓ when transferring patients from one unit to another.",
...
# background info
fe = FormElement.create form_id: form.id, element_type_id: ElementType.find_by_e_type("radio").id, element_id: 22, element_name: "element_22_1", element_title: "How long have you worked in your current hospital?", warn_if_empty: true
...
# background info
fe = FormElement.create form_id: form.id, element_type_id: ElementType.find_by_e_type("radio").id, element_id: 23, element_name: "element_23_1", element_title: "How long have you worked in this hospital work area/unit?", warn_if_empty: true
